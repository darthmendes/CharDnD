...
forgot_some = {
    ...
    Spell(
        ...
        range="30 feet",
        components="V, S, M",
        material_components="a small silver mirror",
        duration="1 minute",
        concentration=False,
        ritual=False,
        target_type="single",
    ...
    Spell(
        ...
        higher_levels="When you cast this spell using a spell slot of 5th or 6th level, the bonus to attack rolls becomes +2 and the extra damage increases to 2d4. When you use a spell slot of 7th level or higher, the bonus becomes +3 and the extra damage becomes 3d4.",
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="10 feet",
        components="V, S, M",
        material_components="burning incense",
        duration="10 minutes",
        concentration=False,
        ritual=True,
        target_type="single",
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="Holy power radiates from you in an aura with a 30-foot radius, waking boldness in you and your companions. Until the spell ends, the aura moves with you, centered on you. While in the aura, each friendly creature (including you) deals an extra 1d4 radiant damage when it hits with a weapon attack.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="The next time you make a ranged weapon attack during the spell's duration, the weapon's ammunition, or the weapon itself if it's a thrown weapon, transforms into a bolt of lightning. Lift the attack roll as normal. The target takes 4d8 lightning damage on a hit, or half as much damage on a miss, instead of the weapon's normal damage. Whether you hit or miss, each creature within 10 feet of the target must make a Dexterity saving throw. Each of these creatures takes 2d8 lightning damage on a failed save, or half as much damage on a successful one. The piece of ammunition or weapon then returns to its normal form.",
    ...
    Spell(
        ...
        range="Self",
        components="V, S, M",
        material_components="a leaf of sumac",
        duration="Concentration, up to 10 minutes",
        concentration=True,
        ritual=False,
        target_type="single",
    ...
    Spell(
        ...
        range="Touch",
        components="V, S, M",
        material_components="a pinch of graveyard dirt",
        duration="1 hour",
        concentration=False,
        ritual=True,
        target_type="single",
    ...
    # Flame Arrows (Xanathar's Guide to Everything)
    Spell(
        name="Flame Arrows",
        level=3,
        school="Transmutation",
        ...
        healing_dice=None,
        healing_type=None,
        description="You touch a quiver containing arrows or bolts. When a target is hit by a ranged weapon attack using a piece of ammunition drawn from the quiver, the target takes an extra 1d6 fire damage. The spell's magic ends on a piece of ammunition when it hits or misses, and the spell ends when there are no more pieces of ammunition in the quiver.",
        higher_levels="When you cast this spell using a spell slot of 4th level or higher, the number of pieces of ammunition you can affect increases by two for each slot level above 3rd.",
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="150 feet",
        components="V, S, M",
        material_components="a pickled octopus tentacle",
        duration="Concentration, up to 1 minute",
        concentration=True,
        ritual=False,
        target_type="aoe",
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You step into a stone object or surface large enough to fully contain your body, melding yourself and all the equipment you carry with the stone for the duration. Using your movement, you step into the stone at a point you can touch. Nothing of your presence remains visible or otherwise detectable by nonmagical means. While you are merged with the stone, you can't see what occurs outside it, and any Wisdom (Perception) checks you make to hear sounds outside it are made with disadvantage. You remain aware of the passage of time and can cast spells on yourself while merged in the stone. You can use a small amount of your movement to leave the stone where you entered it, which ends the spell. You otherwise can't move.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        aoe_size=None,
        damage_dice="1d8",
        damage_type="radiant/necrotic/poison",
        damage_at_character_level=False,
        cantrip_scaling_levels=None,
        cantrip_scaling_dice=None,
        upcast_damage_per_slot="1d8",
        ...
        healing_dice=None,
        healing_type=None,
        description="You call forth spirits of the dead, which flit around you for the spell's duration. The spirits are intangible and invulnerable. When you cast this spell, choose damage type: radiant, necrotic, or poison. Until the spell ends, any attack you make deals 1d8 extra damage of the chosen type when you hit a creature within 10 feet of you. This damage increases by 1d8 for every two spell slot levels above 3rd. Any creature within 10 feet of you that moves must succeed on a Wisdom saving throw or have its speed reduced by 10 feet until the start of your next turn.",
        higher_levels="When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d8 for every two spell slot levels above 3rd.",
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="For the duration, you or one willing creature you can see within range has resistance to psychic damage, as well as advantage on Intelligence, Wisdom, and Charisma saving throws. The spell can affect a creature other than you if you maintain concentration on it for the full duration. Otherwise, the spell ends early.",
        higher_levels=None,
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="60 feet",
        components="V, S, M",
        material_components="one holly berry per creature summoned",
        duration="Concentration, up to 1 hour",
        concentration=True,
        ritual=False,
        target_type="single",
    ...
    Spell(
        ...
        range="90 feet",
        components="V, S, M",
        material_components="a piece of tentacle from a giant octopus or squid",
        duration="Concentration, up to 1 minute",
        concentration=True,
        ritual=False,
        target_type="aoe",
        ...
        higher_levels="When you cast this spell using a spell slot of 5th level or higher, the damage increases by 1d6 for each slot level above 4th.",
        source="Player's Handbook",
        source_page=None
    ),
    
    # Galder's Speedy Courier (Tasha's Cauldron of Everything)
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You summon a spirit that takes the form of an animal, such as an owl, a cat, or a dog. The spirit has an Intelligence of 10 and can understand one language of your choice that you speak. It obeys your commands. The spirit can travel up to 60 miles in 1 hour to deliver a message or small object to a specific creature or location you describe.",
        higher_levels=None,
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You conjure a vine that sprouts from the ground in an unoccupied space that you can see within range. When you cast this spell, you can direct the vine to lash out at a creature within 30 feet of it. That creature must succeed on a Dexterity saving throw or be pulled 20 feet directly toward the vine. Until the spell ends, you can direct the vine to lash out at the same creature or another one as a bonus action on each of your turns.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="30 feet",
        components="V, S, M",
        material_components="a hemispherical piece of clear crystal and a matching hemispherical piece of gum arabic",
        duration="Concentration, up to 1 minute",
        concentration=True,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="A sphere of shimmering force encloses a creature or object of Large size or smaller within range. An unwilling creature must succeed on a Dexterity saving throw or be enclosed for the duration. Nothing—not physical objects, energy, or other spell effects—can pass through the barrier, in or out, though a creature in the sphere can breathe there.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="Self",
        components="V, S, M",
        material_components="the corpse of a humanoid",
        duration="Concentration, up to 1 minute",
        concentration=True,
        ritual=False,
        target_type="self",
        ...
        healing_dice=None,
        healing_type=None,
        description="Flame-like shadows wreathe your body until the spell ends, causing you to become heavily obscured to others. The shadows turn dim light within 10 feet of you into darkness, and bright light in the same radius to dim light. Until the spell ends, you have resistance to radiant damage. In addition, whenever a creature within 10 feet of you hits you with an attack, the shadows lash out at that creature, dealing it 2d8 necrotic damage.",
        higher_levels=None,
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="Dim, greenish light spreads within a 30-foot-radius sphere centered on a point you choose within range. The light spreads around corners, and it lasts until the spell ends. When a creature moves into the spell's area for the first time on a turn or starts its turn there, that creature must make a Constitution saving throw. On a failed save, the creature takes 4d10 radiant damage, and it has one level of exhaustion and becomes sensitive to bright light until the spell ends.",
        higher_levels=None,
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        aoe_size=20,
        damage_dice="2d6",
        damage_type="bludgeoning/lightning",
        damage_at_character_level=False,
        cantrip_scaling_levels=None,
        cantrip_scaling_dice=None,
        upcast_damage_per_slot="1d6",
        ...
        healing_dice=None,
        healing_type=None,
        description="A 20-foot-radius sphere of whirling air springs into existence centered on a point you choose within range. The sphere lasts for the duration. Each creature in the sphere when it appears or that ends its turn there must succeed on a Strength saving throw or take 2d6 bludgeoning damage. The sphere's space is difficult terrain. Until the spell ends, you can use a bonus action on each of your turns to cause a bolt of lightning to leap from the center of the sphere toward one creature you choose within 60 feet of the center. Make a ranged spell attack. You have advantage on the attack roll if the target is in the sphere. On a hit, the target takes 4d6 lightning damage.",
        higher_levels="When you cast this spell using a spell slot of 6th level or higher, the damage increases by 1d6 for each slot level above 5th.",
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    
    # Summon Construct (Tasha's Cauldron of Everything)
    Spell(
        ...
        range="90 feet",
        components="V, S, M",
        material_components="a piece of iron, a piece of wood, and a piece of stone",
        duration="Concentration, up to 1 hour",
        concentration=True,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="You call forth a construct spirit. It manifests in an unoccupied space that you can see within range. Use the Construct Spirit stat block. The creature is friendly to you and your companions for the duration.",
        higher_levels=None,
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
    
    # Vitriolic Sphere (PHB)
    Spell(
        ...
        range="150 feet",
        components="V, S, M",
        material_components="a drop of bile",
        duration="Instantaneous",
        concentration=False,
        ritual=False,
        target_type="aoe",
        ...
        healing_dice=None,
        healing_type=None,
        description="You create a 20-foot-radius sphere of green, shimmering acid centered on a point you choose within range. The sphere appears for a moment and vanishes. Each creature in that area must make a Dexterity saving throw. On a failed save, a target takes 10d4 acid damage and 5d4 acid damage at the end of its next turn. On a successful save, the target takes half the initial damage and no damage at the end of its next turn.",
        higher_levels="When you cast this spell using a spell slot of 6th level or higher, the initial damage increases by 2d4 for each slot level above 5th.",
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="150 feet",
        components="V, S, M",
        material_components="one piece of ammunition or one thrown weapon",
        duration="Instantaneous",
        concentration=False,
        ritual=False,
        target_type="aoe",
        ...
        healing_dice=None,
        healing_type=None,
        description="You fire a piece of nonmagical ammunition from a ranged weapon or throw a nonmagical weapon into the air and choose a point within range. Hundreds of duplicates of the launching weapon or ammunition fall in a volley from above and then disappear. Each creature in a 40-foot-radius, 20-foot-high cylinder centered on that point must make a Dexterity saving throw. A creature takes 4d6 damage on a failed save, or half as much damage on a successful one.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        higher_levels="When you cast this spell using a spell slot of 6th level or higher, the fire damage increases by 1d6 for each slot level above 5th.",
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="Touch",
        components="V, S, M",
        material_components="herbs, oils, and incense worth at least 1,000 gp",
        duration="Until dispelled",
        concentration=False,
        ritual=False,
        target_type="aoe",
        ...
        healing_dice=None,
        healing_type=None,
        description="You touch a point and infuse an area around it with holy (or unholy) power. The area can have a radius up to 60 feet, and the spell fails if the radius includes an area already under the effect a hallow spell. The affected area is subject to the following effects: Celestials, elementals, fey, fiends, and undead can't enter the area, nor can such creatures charm, frighten, or possess creatures within it. Any creature charmed, frightened, or possessed by such a creature is no longer charmed, frightened, or possessed.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You imbue a weapon you touch with holy power. Until the spell ends, the weapon emits bright light in a 30-foot radius and dim light for an additional 30 feet. In addition, weapon attacks made with it deal an extra 2d8 radiant damage on a hit. If the weapon isn't already a magic weapon, it becomes one for the duration. As a bonus action on your turn, you can end this spell and cause the weapon to emit a burst of radiance. Each creature of your choice that you can see within 30 feet of you must make a Constitution saving throw. On a failed save, a creature takes 4d8 radiant damage, and it is blinded for 1 minute. On a successful save, a creature takes half as much damage and isn't blinded.",
        higher_levels=None,
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="A mass of swirling water and foam at least 25 feet tall whips into existence at a point you can see within range. The maelstrom lasts for the duration. Each creature that starts its turn in the area must succeed on a Strength saving throw or take 6d6 bludgeoning damage and be pulled 10 feet toward the center of the area.",
        higher_levels="When you cast this spell using a spell slot of 7th level or higher, the damage increases by 1d6 for each slot level above 6th.",
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="Touch",
        components="V, S, M",
        material_components="rare oils and unguents worth at least 1,000 gp",
        duration="Instantaneous",
        concentration=False,
        ritual=False,
        target_type="single",
    ...
    # Steel Wind Strike (Xanathar's Guide to Everything)
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You flourish the weapon used in the casting and then vanish to strike like the wind. Choose up to five creatures you can see within range. Make a melee spell attack against each target. On a hit, a target takes 6d10 force damage. Whether you hit or miss, you can then teleport to an unoccupied space you can see within 5 feet of one of the targets you hit or missed.",
        higher_levels=None,
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You call out to the spirits of nature to rouse them against your enemies. Choose a point you can see within range. The spirits cause trees, rocks, and grasses in a 60-foot cube centered on that point to become animated until the spell ends. On each of your turns, you can use a bonus action to choose one of the following effects: Creatures take damage, difficult terrain is created, or plants attack.",
        higher_levels="When you cast this spell using a spell slot of 7th level or higher, the damage increases by 1d6 for each slot level above 6th.",
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You create a vertical wall of whirling, razor-sharp blades made of magical energy. The wall appears within range and lasts for the duration. You can make a straight wall up to 100 feet long, 20 feet high, and 5 feet thick, or a ringed wall up to 60 feet in diameter, 20 feet high, and 5 feet thick. The wall provides three-quarters cover to creatures behind it, and its space is difficult terrain. When a creature enters the wall's area for the first time on a turn or starts its turn there, that creature must make a Dexterity saving throw. On a failed save, the creature takes 6d10 slashing damage. On a successful save, the creature takes half as much damage.",
        higher_levels="When you cast this spell using a spell slot of 8th level or higher, the damage increases by 1d10 for each slot level above 7th.",
        source="Player's Handbook",
        source_page=None
    ),
    
    # Bones of the Earth (Xanathar's Guide to Everything)
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You cause up to six pillars of stone to burst from places on the ground that you can see within range. Each pillar is a cylinder that has a diameter of 5 feet and a height of up to 30 feet. The ground where a pillar appears must be wide enough for its diameter, and you can target points under a creature if that creature is Medium or smaller. Each pillar has AC 15 and 30 hit points. When reduced to 0 hit points, a pillar crumbles into rubble that creates a 10-foot-radius area of difficult terrain. If a pillar is created under a creature, that creature must succeed on a Dexterity saving throw or take 6d6 bludgeoning damage and be lifted by the pillar.",
        higher_levels="When you cast this spell using a spell slot of 8th level or higher, you can create two additional pillars for each slot level above 7th.",
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You summon a fey creature of challenge rating 6 or lower, or a fey spirit that takes the form of a beast of challenge rating 6 or lower. It appears in an unoccupied space that you can see within range. The fey creature disappears when it drops to 0 hit points or when the spell ends. The fey creature is friendly to you and your companions for the duration.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    
    # Create Homunculus (Xanathar's Guide to Everything)
    Spell(
        ...
        range="Touch",
        components="V, S, M",
        material_components="clay, ash, mandrake root, spring water, and a ruby worth at least 1,000 gp",
        duration="Instantaneous",
        concentration=False,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="While speaking an arcane incantation, you use a ruby worth at least 1,000 gp to create a Tiny construct called a homunculus. The homunculus is created in an unoccupied space on the ground within range. If you are within 120 feet of the homunculus, you can see what the homunculus sees as a bonus action. It obeys your commands. The homunculus has 5 hit points and can fly at 30 feet.",
        higher_levels=None,
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="Touch",
        components="V, S, M",
        material_components="a sapphire worth at least 1,000 gp",
        duration="Until dispelled",
        concentration=False,
        ritual=True,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="You touch an object weighing 10 pounds or less whose longest dimension is 6 feet or less. The spell leaves an invisible mark on its surface and invisibly inscribes the name of the item on a sapphire you hold. For the duration, you can use a bonus action and speak the item's name to crush the sapphire and cause the item to instantly appear in your hand, regardless of physical and planar distances, and the spell ends. If another creature is holding or carrying the item, crushing the sapphire doesn't transport the item to you.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="0 feet",
        components="V, S, M",
        material_components="mistletoe worth at least 1,000 gp",
        duration="24 hours",
        concentration=False,
        ritual=False,
        target_type="aoe",
        ...
        healing_dice=None,
        healing_type=None,
        description="You invoke the spirits of nature to protect an area outdoors or underground. The area can be as small as a 30-foot cube or as large as a 180-foot cube. The spell fails if you cast it in an area that has already been affected by this spell. For the duration, the area is protected from extraplanar creatures and magical scrying sensors.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="Touch",
        components="V, S, M",
        material_components="holy water, rare incenses, and powdered ruby worth at least 5,000 gp",
        duration="1 day",
        concentration=False,
        ritual=False,
        target_type="aoe",
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="A frigid globe of cold energy streaks from your fingertips to a point of your choice within range, where it explodes in a 60-foot-radius sphere. Each creature within the area must make a Dexterity saving throw. On a failed save, a creature takes 10d6 cold damage. On a successful save, a creature takes half as much damage. If the globe strikes a body of water or a liquid that is principally water (not including water-based creatures), it freezes the liquid to a depth of 6 inches over an area 30 feet square.",
        higher_levels="When you cast this spell using a spell slot of 8th level or higher, the damage increases by 1d6 for each slot level above 7th.",
        source="Player's Handbook",
        source_page=None
    ),
    
    # Otto's Irresistible Dance (PHB)
    Spell(
    ...
    Spell(
        ...
        range="60 feet",
        components="V, S",
        material_components="an offering worth at least 1,000 gp",
        duration="Instantaneous",
        concentration=False,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="You beseech an otherworldly being for aid. The being must be known to you: a god, a primordial, a demon prince, or some other being of cosmic power. That being sends a celestial, an elemental, or a fiend loyal to it to aid you, making the creature appear in an unoccupied space within range. The creature disappears when it drops to 0 hit points or when the spell ends.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    
    # Primordial Ward (Xanathar's Guide to Everything)
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You have resistance to the following damage types until the spell ends: acid, cold, fire, lightning, and thunder. When you take damage of one of those types, you can use your reaction to gain immunity to that type of damage, including against the triggering damage. If you do so, the resistance ends, and you have the immunity until the end of your next turn, at which time the spell ends.",
        higher_levels=None,
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    
    # Summon Fiend (Tasha's Cauldron of Everything)
    Spell(
        name="Summon Fiend",
        level=7,
        school="Conjuration",
        ...
        range="90 feet",
        components="V, S, M",
        material_components="humanoid blood inside a ruby vial worth at least 600 gp",
        duration="Concentration, up to 1 hour",
        concentration=True,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="You call forth a fiendish spirit. It manifests in an unoccupied space that you can see within range. Use the Fiendish Spirit stat block. The creature is friendly to you and your companions for the duration.",
        higher_levels=None,
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You use magic to traverse distances by means of plant life. Into a plant the same size as you or larger, you must place your hand. Then, you must have traveled over the same route as the plant before, and the destination plant must be on the same plane of existence as you. You and up to eight willing creatures who link hands are instantly transported to the destination plant.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="120 feet",
        components="V, S, M",
        material_components="a handful of thorns",
        duration="Concentration, up to 10 minutes",
        concentration=True,
        ritual=False,
        target_type="aoe",
        ...
        higher_levels="When you cast this spell using a spell slot of 8th level or higher, the damage increases by 2d8 for each slot level above 7th.",
        source="Player's Handbook",
        source_page=None
    ),
    
    # ==================== LEVEL 8 ====================
    # Draconic Transformation (Fizban's Treasury of Dragons)
    Spell(
        ...
        range="Self",
        components="V, S, M",
        material_components="a scale from a dragon",
        duration="Concentration, up to 1 minute",
        concentration=True,
        ritual=False,
        target_type="self",
        ...
        healing_dice=None,
        healing_type=None,
        description="You invoke the power of dragonkind. For the duration, you gain the following benefits: You gain 30 temporary hit points, you gain a flying speed of 60 feet, and you can use a bonus action to exhale destructive energy. Each creature in a 60-foot cone must make a Dexterity saving throw, taking 6d6 force damage on a failed save, or half as much damage on a successful one.",
        higher_levels=None,
        source="Fizban's Treasury of Dragons",
        source_page=None
    ),
    
    # Dream of the Blue Veil (Tasha's Cauldron of Everything)
    Spell(
        ...
        range="60 feet",
        components="V, S, M",
        material_components="a handful of sand from the destination plane",
        duration="6 hours",
        concentration=False,
        ritual=False,
        target_type="multiple",
        ...
        healing_dice=None,
        healing_type=None,
        description="You and up to eight willing creatures within range fall unconscious for the duration and experience a vision of a world of your choice that is on a different plane of existence from you. At the end of the spell, you and the creatures who underwent the vision instantly travel to the world you envisioned, arriving in an unoccupied space of your choice.",
        higher_levels=None,
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="A blast of fire springs from your hand. You create ten 10-foot cubes of fire at points you can see within range. Each creature in those cubes must make a Dexterity saving throw. A creature takes 7d10 fire damage on a failed save, or half as much damage on a successful one. The fire damages objects in the area and ignites flammable objects that aren't being worn or carried.",
        higher_levels="When you cast this spell using a spell slot of 9th level or higher, the damage increases by 1d10 for each slot level above 8th.",
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="300 feet",
        components="V, S, M",
        material_components="a miniature portal carved from ivory, a small piece of polished marble, and a tiny silver spoon",
        duration="24 hours",
        concentration=False,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="You conjure an extradimensional dwelling in range that lasts for the duration. You choose where its one entrance is located. The entrance shimmers faintly and is 5 feet wide and 10 feet tall. You and any creature you designate when you cast the spell can enter the extradimensional dwelling as long as the portal remains open. You can open or close the portal if you are within 30 feet of it.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    ...
    Spell(
        ...
        range="60 feet",
        components="V, S, M",
        material_components="a miniature platinum sword worth at least 250 gp",
        duration="1 minute",
        concentration=True,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="You create a sword of planar force that hovers within range. It lasts for the duration. When the sword appears, you make a melee spell attack against a target of your choice within 5 feet of the sword. On a hit, the target takes 3d10 force damage. Until the spell ends, you can use a bonus action on each of your turns to move the sword up to 20 feet to a spot you can see and repeat this attack against the same target or a different one.",
        higher_levels=None,
        source="Player's Handbook",
        source_page=None
    ),
    
    # Temple of the Gods (Xanathar's Guide to Everything)
    Spell(
        ...
        range="120 feet",
        components="V, S, M",
        material_components="a holy symbol worth at least 5,000 gp",
        duration="24 hours",
        concentration=False,
        ritual=False,
        target_type="aoe",
        ...
        healing_dice=None,
        healing_type=None,
        description="You cause a temple to shimmer into existence on ground you can see within range. The temple is dedicated to any god, pantheon, or philosophy of your choice. You decide its appearance, but it is composed of stone and has a floor space of up to 120 feet by 120 feet and a height of up to 120 feet. The temple is filled with religious iconography appropriate to the god or philosophy you chose.",
        higher_levels=None,
        source="Xanathar's Guide to Everything",
        source_page=None
    ),
    ...
    # Telepathy (Tasha's Cauldron of Everything)
    Spell(
        name="Telepathy",
        level=9,
        school="Divination",
        ...
        range="Unlimited",
        components="V, S, M",
        material_components="a pair of linked silver rings",
        duration="24 hours",
        concentration=False,
        ritual=False,
        target_type="single",
        ...
        healing_dice=None,
        healing_type=None,
        description="You create a telepathic link between yourself and a willing creature with which you are familiar. The creature can be anywhere on the same plane of existence as you. The spell ends if you and the subject are no longer on the same plane. Until the spell ends, you and the target can instantaneously share words, images, sounds, and other sensory messages with one another through the link.",
        higher_levels=None,
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
    ...
    Spell(
        ...
        healing_dice=None,
        healing_type=None,
        description="You create a blade-shaped planar rift approximately 3 feet long in an unoccupied space you can see within range. The blade lasts for the duration. You can use a bonus action to move the blade up to 30 feet to an unoccupied space you can see, and you can use your action to make a melee spell attack with it. On a hit, the target takes 6d10 force damage. This attack scores a critical hit on a roll of 19 or 20.",
        higher_levels=None,
        source="Tasha's Cauldron of Everything",
        source_page=None
    ),
